...
This section will explain how to configure a web server as a reverse
proxy in front of automx2. But before you set up the proxy you need to tell
automx2 it operates behind one. Add the `proxy_count` parameter to your automx2
