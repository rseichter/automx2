...
There are packages available for link:https://aur.archlinux.org/packages/automx2[Arch Linux] and link:https://search.nixos.org/packages?type=packages&query=automx2[NixOS].
