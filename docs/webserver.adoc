...
Features such as transport layer encryption for HTTPS or, for example, the capability to rate-limit clients are handled very well by full-fledged web servers working as reverse proxies.
...
<1> You should turn off echoing SQL commands to the log once you have verified automx2 works as expected.
