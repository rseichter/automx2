...
Note that JSON can not currently be used to configure LDAP server support, and does not offer the same degree of flexibility for specifying relationships between multiple domains and servers.
...
The supported JSON data format is as follows:
